            ...
            <div id="wbox" class="widgetrow text-center">
                ...
                @else
                    <span onclick="javascript: window.location.href='{{ url('auth/login') }}';">
                        <a href="{{ url('auth/login') }}" class="widgetrowitem defaultwidget"
                ...
                <div class="form-border">
                    ...
                    <div class="form-group has-feedback {{ $errors->has('full_name') ? 'has-error' : '' }}"
                        ...
                        <span class="glyphicon glyphicon-user form-control-feedback"
                            style="top: 9px;left: -25px;color: #6c757d;"></span>
                    </div>
                    ...
                    @elseif (($settings->status == 0 || $settings->status == '0') &&
                        ($email_mandatory->status == 0 || $email_mandatory->status == '0'))
                        <div class="form-group has-feedback {{ $errors->has('email') ? 'has-error' : '' }}"
                            style="display: -webkit-box;">
                            {!! Form::text('email', null, ['placeholder' => Lang::get('lang.email'), 'class' => 'form-control']) !!}
                            <span class="glyphicon glyphicon-envelope form-control-feedback"
                    ...
                    <div class="form-group has-feedback {{ $errors->has('password_confirmation') ? 'has-error' : '' }}"
                        ...
                        {!! Form::password('password_confirmation', [
                            'placeholder' => Lang::get('lang.retype_password'),
                            'class' => 'form-control',
                        ]) !!}
                    ...
                    <div>
                        ...
                        <div class="checkbox icheck" align="center">
                            <label class="mb-0">
                                {!! Lang::get('lang.account') !!} <a href="{{ url('auth/login') }}"
