    ...
    <div class="card card-light">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button class="btn btn-default btn-tool" data-toggle="modal" data-target="#create" title="Create"
                    id="2create">
                ...
                <tbody>
                    @foreach ($sets as $set)
                        <tr>
                            ...
                            <td>
                                <?php
                                $settings = DB::table('settings_email')
                                    ->whereId(1)
                                    ->first();
                                ...
                                <button class="btn btn-danger btn-sm {!! $dis !!}" data-toggle="modal"
                                    data-target="#delete{{ $set->id }}">{!! Lang::get('lang.delete') !!}</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @foreach ($errors->all() as $error)
                        <div class="alert alert-danger alert-dismissable">
                            <i class="fas fa-ban"></i><button type="button" class="close" data-dismiss="alert"
