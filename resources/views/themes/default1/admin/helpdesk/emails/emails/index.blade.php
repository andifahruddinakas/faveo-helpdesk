                ...
                @foreach ($emails as $email)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('emails.edit', $email->id) }}" class="btn btn-primary btn-xs"><i
                                    class="fas fa-edit"> </i> {!! Lang::trans('lang.edit') !!}</a>
                            <!-- To pop up a confirm Message -->

                            @if ($default_email == $email->id)
                                {!! Form::button('<i class="fas fa-trash"> </i> ' . Lang::trans('lang.delete'), ['class' => 'btn btn-danger btn-xs ' . $disabled]) !!}
                            @else
                                {!! Form::button('<i class="fas fa-trash"> </i> ' . Lang::trans('lang.delete'), ['type' => 'submit', 'class' => 'btn btn-danger btn-xs', 'onclick' => 'return confirm("Are you sure?")']) !!}
                            @endif
