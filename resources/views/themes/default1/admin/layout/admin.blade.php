    ...
    as $notification)
                ...
                <li class="nav-item dropdown user-menu">
                    ...
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        @if (Auth::user())
                            <img src="{{ Auth::user()->profile_pic }}"class="user-image img-circle elevation-2"
                                alt="User Image" />
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li class="user-header bg-secondary" style="background-color:#343F44;">
                            @if (Auth::user())
                                <img src="{{ Auth::user()->profile_pic }}" class="img-circle elevation-2"
                                    alt="User Image" />
        ...
        <aside class="main-sidebar elevation-4 sidebar-dark-orange">
            ...
            <a href="{{ config('app.url') }}" class="brand-link navbar-orange" style="text-align: center;">
                        ...
                        @if ($replaceside == 0)
                            ...
                            <li @yield('settings-menu-parent') class="nav-item">
                                ...
                                <ul @yield('settings-menu-open') class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url('settings-notification') }}" @yield('notification')
                                            class="nav-link">
                                            <i class="nav-icon fas fa-bell"></i>
                            ...
                            {{-- <li @yield('error-menu-parent') class="nav-item">
                                ...
                                <ul @yield('error-menu-open') class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('err.debug.settings') }}" @yield('debugging-option')
                                            class="nav-link">
            ...
            <section class="content">
                ...
                @if ($dummy_installation == 1 || $dummy_installation == '1')
                    ...
                    <div class="alert alert-info alert-dismissible">
                        ...
                        {{ Lang::get('lang.dummy_data_installation_message') }}
                        <a href="{{ route('clean-database') }}">{{ Lang::get('lang.click') }}</a>
