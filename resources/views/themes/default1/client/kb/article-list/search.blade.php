        ...
        @forelse($result as $arti)
            <article class="format-standard type-post hentry clearfix">
                ...
                <div class="post-meta clearfix">
                    <span class="date"><i class="fa fa-clock-o fa-fw"></i>
                        {{ $arti->created_at->format('l, d-m-Y') }}</span>
...
@section('category')
    <h2 class="section-title h4 clearfix">{!! Lang::get('lang.categories') !!}<small class="pull-right"><i
                class="fa fa-hdd-o fa-fw"></i></small></h2>
