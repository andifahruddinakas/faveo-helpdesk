    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    ?>
                    <?php $myticket = App\Model\helpdesk\Ticket\Tickets::where('assigned_to', Auth::user()->id)
                        ->where('status', '1')
                        ->get(); ?>
                    <?php $unassigned = App\Model\helpdesk\Ticket\Tickets::where('assigned_to', '0')
                        ->where('status', '1')
                        ->get();
                    ...
                    <div class="tabs-content">
                        ...
                        <div class="tabs-pane @yield('emails-bar')" id="tabC">
                            <ul class="nav navbar-nav">
                                ...
                                <li id="bar" @yield('ban')><a href="{{ url('banlist') }}">Ban List</a>
                                </li>
                                <li id="bar" @yield('template')><a href="{{ url('template') }}">Template</a>
                                </li>
                                <li id="bar" @yield('diagno')><a
                                        href="{{ url('getdiagno') }}">Diagnostic</a></li>
                                <li id="bar" @yield('smtp')><a href="{{ url('getsmtp') }}">Smtp</a></li>
                            </ul>
                        </div>
                        <div class="tabs-pane @yield('manage-bar')" id="tabD">
                            <ul class="nav navbar-nav">
                                <li id="bar" @yield('help')><a href="{{ url('helptopic') }}">Help
                                        Topic</a>
                                </li>
                                <li id="bar" @yield('sla')><a href="{{ url('sla') }}">SLA Plans</a>
                                </li>
                        ...
                        <div class="tabs-pane @yield('settings-bar')" id="tabE">
                            <ul class="nav navbar-nav">
                                <li id="bar" @yield('company')><a href="{{ url('getcompany') }}">Company</a>
                                </li>
                                <li id="bar" @yield('system')><a href="{{ url('getsystem') }}">System</a>
                                </li>
                                <li id="bar" @yield('email')><a href="{{ url('getemail') }}">Email</a>
                                </li>
                                <li id="bar" @yield('tickets')><a href="{{ url('getticket') }}">Tickets</a>
                                </li>
                                <li id="bar" @yield('access')><a href="{{ url('getaccess') }}">Access</a>
                                </li>
                                <li id="bar" @yield('auto-response')><a
                                        href="{{ url('getresponder') }}">Auto-Responce</a></li>
                                <li id="bar" @yield('alert')><a href="{{ url('getalert') }}">Alert &
                                        Notice</a></li>
                            </ul>
                        </div>
                        <div class="tabs-pane @yield('theme-bar')" id="tabF">
                            <ul class="nav navbar-nav">
                                <li id="bar" @yield('footer')><a
                                        href="{{ url('create-footer') }}">Footer</a></li></a></li>
                                <li id="bar" @yield('footer2')><a
                                        href="{{ url('create-footer2') }}">Footer2</a></li></a></li>
                                <li id="bar" @yield('footer3')><a
                                        href="{{ url('create-footer3') }}">Footer3</a></li></a></li>
                                <li id="bar" @yield('footer4')><a
                                        href="{{ url('create-footer4') }}">Footer4</a></li></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; {!! date('Y') !!} <a
                    href="{!! $company->website !!}">{!! $company->company_name !!}</a>.</strong> All rights reserved. Powered
            by <a href="http://www.faveohelpdesk.com/" target="blank">Faveo</a>
        </footer>
    </div><!-- ./wrapper -->
