                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                @if (Auth::user())
                                    @if (Auth::user()->profile_pic)
                                        <img src="{{ asset('lb-faveo/lb-faveo/dist/img') }}{{ '/' }}{{ Auth::user()->profile_pic }}"class="user-image"
                                            alt="User Image" />
                                    @else
...
?>
        ...
        $group = App\Model\helpdesk\Agent\Groups::where('name', '=', $agent_group)
                    ...
                    <div class="tabs-content">
                        <div class="tabs-pane @yield('dashboard-bar')" id="tabA">
                            <ul class="nav navbar-nav">
                                ...
                                <li id="bar" @yield('profile')><a href="{{ url('profile') }}">Profile</a>
                                </li>
                            </ul>
                        </div>
                        <div class="tabs-pane @yield('user-bar')" id="tabB">
                            <ul class="nav navbar-nav">
                                <li id="bar" @yield('user')><a href="{{ url('user') }}">User
                                        Directory</a></li></a></li>
                        ...
                        <div class="tabs-pane @yield('ticket-bar')" id="tabC">
                            <ul class="nav navbar-nav">
                                <li id="bar" @yield('open')><a href="{{ url('/ticket/open') }}">Open</a>
                                </li>
                                <li id="bar" @yield('answered')><a
                                        href="{{ url('/ticket/answered') }}">Answered</a></li>
                                ...
                                <li id="bar" @yield('overdue')><a
                                        href="{{ url('/ticket/overdue') }}">Overdue</a></li>
                                <li id="bar" @yield('closed')><a
                                        href="{{ url('/ticket/closed') }}">Closed</a></li>
                                <?php if ($group->can_create_ticket == 1) {?>
                                <li id="bar" @yield('newticket')><a href="{{ url('/newticket') }}">Create
                                        Ticket
                                    </a></li>
                                <?php }
?>
        ...
        <footer class="main-footer">
            ...
            by <a href="http://www.faveohelpdesk.com/">Faveo</a>
        </footer>
    </div><!-- ./wrapper -->
